	...
	static void drive(double leftAxisX, double leftAxisY, double rightAxisZ, bool correctOverride){
		if(DriveTrainPrivate::ticksModTicksSpeed == 0){
			...
			*/
			...
			double rlTi = irlTi;
			double rrTi = irrTi;
			DriveTrainPrivate::a = flTi;
			DriveTrainPrivate::b = frTi;
			DriveTrainPrivate::c = rlTi;
			DriveTrainPrivate::d = rrTi;
		...
		// std::cout << "-><-\n";
		 ...
		 SmartDashboard::PutNumber("Encoder fl", DriveTrainPrivate::a);
		 SmartDashboard::PutNumber("Encoder fr", DriveTrainPrivate::b);
		 SmartDashboard::PutNumber("Encoder rl", DriveTrainPrivate::c);
		 SmartDashboard::PutNumber("Encoder rr", DriveTrainPrivate::d);

		 SmartDashboard::PutNumber("Correction fl", DriveTrainPrivate::flTi);
		 SmartDashboard::PutNumber("Correction fr", DriveTrainPrivate::frTi);
		 SmartDashboard::PutNumber("Correction rl", DriveTrainPrivate::rlTi);
		 SmartDashboard::PutNumber("Correction rr", DriveTrainPrivate::rrTi);
